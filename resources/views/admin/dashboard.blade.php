    ...
    <div class="row flex-nowrap">
        ...
        <div class="col offset-xl-2 col offset-lg-3 offset-md-3 offset-sm-3 offset-4 col-md-9 col-xl-10 py-3">
            ...
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <div class="card shadow">
                        <h4 class="card-header" style="background-color: #393E46; color:#EEEEEE">Jumlah Kain</h4>
                ...
                <div class="col-lg-4">
                    <div class="card shadow">
                        <h4 class="card-header" style="background-color: #393E46; color:#EEEEEE">Gambar Kain</h4>
                        <div class="card-body" style="max-height: 340px;  height: 340px; overflow-y:auto">
                ...
                <div class="col-lg-4">
                    <div class="card shadow">
                        <h4 class="card-header" style="background-color: #393E46; color:#EEEEEE">Absensi Karyawan</h4>
                        <div class="card-body" style="max-height: 340px; overflow-y: auto;">
                            <table class="table table-bordered border border-5">
                                <thead>
                                    <tr>
                                        <th class="text-center" style="background-color: #00ADB5; color:#EEEEEE">Nama Karyawan</th>
                                        <th class="text-center" style="background-color: #00ADB5; color:#EEEEEE">Total Absensi</th>
                                    </tr>
                                </thead>
                                <tbody>
            ...
            <div class="row mt-5">
                <div class="col-lg-7">
                    <div class="card shadow">
                        <h4 class="card-header" style="background-color: #393E46; color:#EEEEEE">Incomes</h4>
                        <div class="card-body">
                ...
                <div class="col-lg-5">
                    <div class="card shadow">
                        <h4 class="card-header" style="background-color: #393E46; color:#EEEEEE">OnProses</h4>
                        <div class="card-body" style="max-height: 340px; overflow-y: auto;">
                            @if (count($fabrics) === 0)
