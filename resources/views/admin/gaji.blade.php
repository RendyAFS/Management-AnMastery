                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12">
                        <div class="d-flex justify-content-end">
                            ...
                            <a href="" class="btn btn-danger d-flex align-items-center me-2 shadow"
                                data-bs-toggle="modal" data-bs-target="#deleteGaji">
                                <i class="bi bi-trash-fill align-middle fs-4 me-2"></i> Hapus Semua Gaji
                            </a>


                            <a href="" class="btn btn-primary d-flex align-items-center ms-2 shadow"
                                data-bs-toggle="modal" data-bs-target="#InputGaji">
                                <i class="bi bi-credit-card-2-back align-middle fs-4 me-2"></i> Input Gaji
                            </a>
                        </div>

                        <!-- Modal -->
                        <div class="modal fade" id="deleteGaji" tabindex="-1" aria-labelledby="deleteGajiLabel"
                            aria-hidden="true">
                                    ...
                                    <div class="modal-body">
                                        <div class="d-flex justify-content-center peringatan">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="180" height="180"
                                                fill="#F68731" class="bi bi-exclamation-circle" viewBox="0 0 16 16">
                                                <path
                                            ...
                                            <div class="col-lg-12">
                                                <div class="d-flex justify-content-center">
                                                    <form action="{{ route('deleteall') }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" class="btn btn-danger me-2">Ya, Hapus
                                                            Semua</button>
                                                    </form>
                        ...
                        <div class="modal fade" id="InputGaji" tabindex="-1" aria-labelledby="InputGajiLabel"
                            aria-hidden="true">
