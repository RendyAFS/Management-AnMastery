...
@section('content')
    <style>
        ...
        #btn-selesaisemua {
            ...
            /* Menyelaraskan horizontal ke tengah */
        }
    ...
    <div class="container-fluid">
        <div class="row flex-nowrap">
            ...
            <div class="col offset-xl-2 col offset-lg-3 offset-md-3 offset-sm-3 offset-4 col-md-9 col-xl-10 py-3">
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12">
                        <div class="d-flex justify-content-end">
                            ...
                            <a href="SelesaiSemua" class="btn btn-warning d-flex align-items-center me-3 shadow"
                                data-bs-toggle="modal" data-bs-target="#selesaiSemua">
                            ...
                            <a href="TambahProses" class="btn btn-primary d-flex align-items-center shadow"
                                data-bs-toggle="modal" data-bs-target="#addProsesModal">
                                <i class="bi bi-file-earmark-plus align-middle fs-4 me-2"></i> Tambah Proses
                            </a>

                        </div>
                        {{-- Modal selesaiSemua --}}
                        <div class="modal fade" id="selesaiSemua" data-bs-backdrop="static" data-bs-keyboard="false"
                            tabindex="-1" aria-labelledby="selesaiSemuaLabel" aria-hidden="true">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="d-flex justify-content-center">
                                                <form action="{{ route('selesaisemua') }}" method="POST">
                                                    ...
                                                    @method('delete')
                                                    <button type="submit"
                                                        class="btn btn-danger d-flex align-middle me-2 shadow">
                        ...
                        <div class="modal fade" id="addProsesModal" tabindex="-1" aria-labelledby="addProsesModalLabel"
                            aria-hidden="true">
                ...
                <div class="row mt-4">
                    <div class="col-lg-4">
                        <div class="card shadow exclude-from-search">
                        ...
                        <div class="row d-flex justify-content-center">
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-4 d-flex justify-content-end align-items-center">
                                    ...
                                    <input type="text" id="searchInput" class="form-control shadow">
                                </div>
                            </div>

                            <div class="text-center no-results mt-5"
                                style="height: 85vh; display: none; justify-content: center; align-items: center; opacity:0.2;">
                                <h1><i class="bi bi-list-task"></i> Data Tidak Ditemukan</h1>
                            </div>
                            @if (count($fabrics) === 0)
                                <div class="text-center"
                                    style="height: 85vh; display: flex; justify-content: center; align-items: center; opacity:0.2;">
                            ...
                            @else
                                @foreach ($fabrics as $fabric)
                                    ...
                                    <div class="card text-white {{ $bgClass }} mb-3 me-3 shadow border border-1 border-dark "
                                        id="anmimasi-card" style="max-width: 15rem;">
                                        ...
                                        <div class="card-footer">
                                            <div class="row ">
                                                <div class="col-lg-12 d-flex justify-content-end">
                                                    <a href="{{ route('onproses.edit', ['onprose' => $fabric->id]) }}"
                                                        class="text-decoration-none btn btn-light me-2 shadow">Edit</a>
                                                    <form
                                                        action="{{ route('onproses.destroy', ['onprose' => $fabric->id]) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('delete')
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            // Get all cards except those with the 'exclude-from-search' class
            var cards = $(".card:not(.exclude-from-search)");
            ...
            $("#searchInput").on("input", function() {
                ...
                // Show "Data Tidak Ditemukan" if no results are found
                if (!resultsFound) {
                    $(".no-results").show();
                } else {
                    $(".no-results").hide();
