            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-8 col-md-12">
                    <div class="d-flex justify-content-end">
                        ...
                        <a href="TambahSupplier" class="btn btn-primary d-flex align-items-center shadow" data-bs-toggle="modal" data-bs-target="#addSupplierModal">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 mt-5">
                        ...
                        <div class="row mt-3 mb-4">
                            ...
                            <div class="col-lg-8">
                                <div class="d-flex justify-content-end">
                                    <a href="TambahGambar" class="btn btn-primary d-flex align-items-center shadow" data-bs-toggle="modal" data-bs-target="#addGkainModal">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="d-flex justify-content-center">
                                                        <form action="{{ route('Gkains.destroy', ['Gkain' => $pic->id]) }}" method="POST">
                                                            @csrf
                                                            @method('delete')
                                                            <button type="submit" class="btn btn-danger btn-delete shadow">
                                                                Ya, Hapus!
                                                            </button>
                                                        </form>
